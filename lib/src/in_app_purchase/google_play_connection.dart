  ...
  Future<bool> buyNonConsumable({@required PurchaseParam purchaseParam}) async {
    BillingResultWrapper billingResultWrapper =
        await billingClient.launchBillingFlow(
            ...
            oldSku: purchaseParam.changeSubscriptionParam == null?null: purchaseParam.changeSubscriptionParam.oldPurchaseDetails.productID,
            purchaseToken: purchaseParam.changeSubscriptionParam == null?null: purchaseParam.changeSubscriptionParam.oldPurchaseDetails.verificationData.serverVerificationData,
